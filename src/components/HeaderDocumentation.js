            ...
            <div className="flex flex-row w-full justify-between">
                ...
                <nav className="flex flex-row w-full">
                    ...
                    <ul className="flex flex-row w-full justify-center mr-24">
                        <li><a href="/mental-health"><img src={feed} alt="Feed" className="h-8 w-8 mx-16"/></a></li>
                        <li><a href="/help"><img src={forums} alt="forums" className="h-8 w-8 mx-16"/></a></li>
                        <li><a href="/recovery"><img src={chatroom} alt="chatroom" className="h-8 w-8 mx-16"/></a></li>
                    </ul>
