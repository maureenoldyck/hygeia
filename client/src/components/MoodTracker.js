                        ...
                        <div className="bg-brown-sand rounded-xl bg-opacity-25 m-1 py-3">
                            ...
                            <div className="flex flex-row justify-center w-full"> 
                                ...
                                <label htmlFor="happyFeeling">
                                    <input type="radio" name="feeling" id="happyFeeling" value="happy" className="happy opacity-0 absolute" onClick={moodtrackerHandler}/> 
                                ...
                                <label htmlFor="neutralFeeling">
                                    <input type="radio" name="feeling" id="neutralFeeling" value="neutral" className="neutral opacity-0 absolute" onClick={moodtrackerHandler} /> 
                                ...
                                <label htmlFor="sadFeeling">
                                    <input type="radio" name="feeling" id="sadFeeling" value="sad" className="sad opacity-0 absolute" onClick={moodtrackerHandler}/> 
