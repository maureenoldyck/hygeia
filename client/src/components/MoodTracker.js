...
const MoodTracker = () => {
    ...
    //     fetch(`https://hygeia-app.herokuapp.com:5000/api/moodtracker/${id}`, {
    //         method: 'POST',
    //         body:  JSON.stringify({
                        ...
                        <div className="bg-brown-sand rounded-xl bg-opacity-25 m-1 py-3">
                            ...
                            <div className="flex flex-row justify-center w-full"> 
                                ...
                                <label htmlFor="happyFeeling">
                                    <input type="radio" name="feeling" id="happyFeeling" value="happy" className="happy opacity-0 absolute" /> 
