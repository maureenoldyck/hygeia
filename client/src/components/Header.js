            ...
            <div className="hidden w-64 mt-2 " id="profile-dropdwn">
                <div className="absolute right-0 px-2 pt-2 pb-3 mt-2 space-y-1 z-50 flex justify-evenly w-64 items-center flex-col md:flex-row rounded-xl border border-brown-clay bg-brown-navajo">
                    <ul className="flex flex-col justify-end w-full">
                        <li>
                            <div className="flex flex-row items-center rounded-xl hover:bg-brown-yellow">
                            <Link to="/profile"><img src={finger} alt="profile" className="h-8 w-8 mx-8 my-2"/></Link>
                            <p>My profile</p>
                            </div>
                        </li>
                        <li>
                            <div className="flex flex-row items-center rounded-xl hover:bg-brown-yellow">
                            <Link to="/profile"><img src={settings} alt="settings" className="h-8 w-8 mx-8 my-2"/></Link>
                            <p>Settings</p>
                            </div>
                        </li>
                        <li>
                            <div className="flex flex-row items-center rounded-xl hover:bg-brown-yellow">
                            <Link to="#"><img src={logout} alt="Log Out" className="h-8 w-8 mx-8 my-2"/></Link>
                            <p>Log Out</p>
                            </div>
                        </li>
                    </ul>
