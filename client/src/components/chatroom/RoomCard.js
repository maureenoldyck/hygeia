...
const RoomCard = () => {
    return (
        <>
        <div className="bg-brown-white w-full rounded-lg mx-4 h-auto shadow-lg">
            <div className="flex flex-row w-full">
                <div className="flex flex-col ml-6 w-nine" id="room-description">
                    ...
                    <div className="border-gray-300 border-l-4 px-4" id="chat-desciption">
                        <p>
                            ...
                            Aequi alias error magnam dolore provident delectus iure. Ea error molestias impedit sequi modi ratione
                        </p>
                    </div>
                ...
                <div className="flex flex-col items-center mx-auto" id="room-scoring">
