                    ...
                    <div className="pt-4" id="documention-nav">
                        <nav>
                            <ul className="flex flex-row justify-around">
                                <li><Link to="/whatis">What is mental Health?</Link></li>
                                <li><Link to="/help">How can I (get) help?</Link></li>
                                <li><Link to="/recovery">Can I recover?</Link></li>
                            </ul>
                        </nav>
                    </div>
                    <div id="carrousel">
                    ...
                    <div className="flex w-full mb-5">
                        <form className="flex flex-col w-full ml-16 mr-32 text-2xl">
                            ...
                            <div className="flex flex-row my-6 justify-around">
                                ...
                                <Link to="/register" className="bg-blue-500 hover:bg-blue-700 text-white w-40 py-2 px-4 rounded-full">Register</Link>
                            </div>
                        </form>
                    </div>
